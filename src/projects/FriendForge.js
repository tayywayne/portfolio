...
function FriendForge() {
    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="lg:py-16">
            ...
            <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                <div className=" text-center"><a href='https://blacksmith-collaborative.gitlab.io/friendforge/' target="_blank">Live Site</a></div>

                <div className="text-center"><a href='https://gitlab.com/blacksmith-collaborative/friendforge' target="_blank">Repo</a></div>
            </div>
    ...
    <section class="text-gray-600 body-font tech-stack">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center flex-shrink-0">
                <img src='https://i.imgur.com/MBOcKLL.png'/>
            </div>
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                <h2 class="text-lg title-font font-medium mb-2">Back-End</h2>
            ...
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                <h2 class="text-lg title-font font-medium mb-2">Front-End</h2>
            ...
            <div class="sm:w-32 sm:order-none order-first sm:h-32 h-20 w-20 sm:ml-10 inline-flex items-center justify-center flex-shrink-0">
                <img src='https://i.imgur.com/jJIGIsp.png'/>
            </div>
            </div>
        </div>
        </section>
        ...
        <section class="body-font">
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="sm:w-1/2 mb-10 px-4">
                    ...
                    <img alt="content" class="object-cover object-center h-full w-full" src="https://i.imgur.com/yAqtuaj.gif"/>
                    </div>
                    <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Join Other Users in Groups</h2>
                    <p class="leading-relaxed text-base">Once a user signs up and fill out their profile, they can join a group that has an open spot with other like minded people!</p>
                </div>
                <div class="sm:w-1/2 mb-10 px-4">
                    <div class="h-64 overflow-hidden">
                    <img alt="content" class="object-cover object-center h-full w-full" src="https://i.imgur.com/dD3lStM.gif"/>
                    </div>
                    <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Chat with your new friends</h2>
                    <p class="leading-relaxed text-base">Users can chat with their new friends in realtime chat, add them as a friend and see their profile!</p>
                </div>
                </div>
            </div>
            </section>
